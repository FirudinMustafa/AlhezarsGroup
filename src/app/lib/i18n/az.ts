...
const az: Translations = {
  ...
  nav: {
    ...
    services: 'Xidmətlər',
    process: 'Proses',
    portfolio: 'Partnyorlar & Portfolio',
    about: 'Haqqımızda',
    getStarted: 'Başlayaq',
  ...
  portfolio: {
    badge: 'Partnyorlar & Portfolio',
    title1: 'Etimad Göstərən',
    title2: 'Brendlər',
    desc: 'Daşınmaz əmlakdan hüquq məsləhətinə, otelçilikdən moda butiklərinə — müxtəlif sektorlardan brendlərlə işləmişik.',
    categoryAll: 'Hamısı',
    categories: {
      realestate: 'Daşınmaz Əmlak',
      hospitality: 'Qonaqpərvərlik & Qida',
      health: 'Sağlamlıq & Gözəllik',
      fashion: 'Moda',
      auto: 'Avtomobil',
      legal: 'Hüquq & Biznes',
      entertainment: 'Əyləncə',
      consumer: 'İstehlak Malları',
    },
    videoBadge: 'Video Prodakşn',
    showMore: 'Daha çox gör',
    showLess: 'Daha az göstər',
    instagramCta: 'Instagram-da izləyin',
    items: [
      { name: 'Sea Breeze', tagline: '20 illik otel təcrübəsi üçün müasir vizual kimlik yeniləməsi.', services: 'Brend Kimliyi • Loqo Dizaynı' },
      { name: 'Unilever', tagline: 'Qlobal istehlak malları şirkətinin yerli fəaliyyətləri üçün brend əməkdaşlığı.', services: 'Brend Kimliyi • Sosial Media' },
      { name: 'Raffle Residences & Hotel Swissôtel', tagline: 'Sahil xətti üzərində lüks rezidens-otel kompleksi üçün tanıtım videosu və brendinq.', services: 'Brend Kimliyi • Video Prodakşn' },
      { name: 'Rise Plaza', tagline: 'Bakının mərkəzində premium ofis mərkəzi — tam vizual kimlik və tanıtım videoları.', services: 'Brend Kimliyi • Video Prodakşn' },
      { name: 'Digital Residence', tagline: 'Rəqəmsal dövrün yaşayış konsepti üçün müasir loqo, brend dizaynı və yaradıcı tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Ganjlik Garden', tagline: 'Yaşıl yaşayış layihəsi üçün premium loqo, institusional brend kimliyi və ailə həyatını əks etdirən tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Münhen Dönər', tagline: 'Sürətli qida şəbəkəsi üçün loqo dizaynı və sosial media tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Microgreens Azərbaycan', tagline: 'Yerli mikrogöyərti istehsalçısı üçün orijinal brend kimliyi və reseptli tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'My Doctor Medical Center', tagline: 'Tibb mərkəzi üçün institusional tanıtım videoları və klinika turu kontenti.', services: 'Video Prodakşn • Sosial Media' },
      { name: "A'Fandy Gallery Parfum", tagline: 'Butik ətriyyat qalereyası üçün lüks, qara-qızılı loqo dizaynı və atmosferik tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Cravatte Gentlemen\'s Boutique', tagline: 'Qalstuk və premium hədiyyəlik butiki üçün 3D animasiyalı məhsul reklamları və premium loqo.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'VLT Autopark.cn', tagline: 'Avtomobil parkı platforması üçün loqo, rəqəmsal brend kimliyi və sosial media tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Aga Playstation', tagline: 'Playstation alqı-satqı və servis xidməti üçün müasir, tanınmış loqo dizaynı.', services: 'Loqo Dizaynı' },
      { name: 'KYB Hüquq Məsləhəti', tagline: 'Hüquq konsaltinq şirkəti üçün ekspert-cavab video seriyası və sosial media kontenti.', services: 'Video Prodakşn • Sosial Media' },
      { name: 'Baku City Karting', tagline: '15 illik əyləncə mərkəzi üçün loqo yeniləməsi və event kimliyi.', services: 'Loqo Dizaynı • Brend Kimliyi' },
      { name: 'Diamond Residence', tagline: 'Xankəndidə yaşayış kompleksi üçün almaz-göydələn motivli premium loqo dizaynı və kinematik tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
      { name: 'Parfumcity', tagline: 'Ətriyyat pərakəndə şəbəkəsi üçün minimalist loqo dizaynı və nağıl üslubunda yaradıcı tanıtım videosu.', services: 'Loqo Dizaynı • Video Prodakşn' },
    ],
  },
