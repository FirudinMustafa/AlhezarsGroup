...
const en: Translations = {
  ...
  portfolio: {
    badge: 'Partners & Portfolio',
    title1: 'Brands That',
    title2: 'Trust Us',
    desc: 'From real estate to legal consulting, hospitality to fashion boutiques — we\'ve worked with brands across industries.',
    categoryAll: 'All',
    categories: {
    ...
    videoBadge: 'Video Production',
    showMore: 'See more',
    showLess: 'Show less',
    instagramCta: 'Follow on Instagram',
    items: [
      { name: 'Sea Breeze', tagline: 'A modern visual identity refresh for a hotel with 20 years of experience.', services: 'Brand Identity • Logo Design' },
      { name: 'Unilever', tagline: 'Brand collaboration for a global consumer goods company\'s local activities.', services: 'Brand Identity • Social Media' },
      { name: 'Raffle Residences & Hotel Swissôtel', tagline: 'A luxury residence-hotel complex on the coastline — promotional video and branding.', services: 'Brand Identity • Video Production' },
      { name: 'Rise Plaza', tagline: 'A premium office center in the heart of Baku — full visual identity and promotional videos.', services: 'Brand Identity • Video Production' },
      { name: 'Digital Residence', tagline: 'A modern logo, brand design, and creative promo video for a digital-age residential concept.', services: 'Logo Design • Video Production' },
      { name: 'Ganjlik Garden', tagline: 'A premium logo, institutional brand identity, and a lifestyle promo video for a green residential project.', services: 'Logo Design • Video Production' },
      { name: 'Münhen Dönər', tagline: 'Logo design and a social media promo video for a fast-food chain.', services: 'Logo Design • Video Production' },
      { name: 'Microgreens Azerbaijan', tagline: 'An original brand identity and recipe-style promo video for a local microgreens producer.', services: 'Logo Design • Video Production' },
      { name: 'My Doctor Medical Center', tagline: 'Institutional promo videos and clinic-tour content for a medical center.', services: 'Video Production • Social Media' },
      { name: "A'Fandy Gallery Parfum", tagline: 'A luxury black-and-gold logo design and an atmospheric promo video for a boutique perfume gallery.', services: 'Logo Design • Video Production' },
      { name: 'Cravatte Gentlemen\'s Boutique', tagline: '3D-animated product ads and a premium logo for a necktie and premium gifts boutique.', services: 'Logo Design • Video Production' },
      { name: 'VLT Autopark.cn', tagline: 'Logo, digital brand identity, and a social media promo video for a car fleet platform.', services: 'Logo Design • Video Production' },
      { name: 'Aga Playstation', tagline: 'A modern, recognizable logo design for a PlayStation console sales and repair service.', services: 'Logo Design' },
      { name: 'KYB Legal Consulting', tagline: 'An expert Q&A video series and social media content for a legal consulting firm.', services: 'Video Production • Social Media' },
      { name: 'Baku City Karting', tagline: 'A logo refresh and event identity for a 15-year-old entertainment center.', services: 'Logo Design • Brand Identity' },
      { name: 'Diamond Residence', tagline: 'A premium logo design with a diamond-skyscraper motif and a cinematic promo video for a residential complex in Khankendi.', services: 'Logo Design • Video Production' },
      { name: 'Parfumcity', tagline: 'A minimalist logo design and a fairy-tale-style creative promo video for a perfume retail chain.', services: 'Logo Design • Video Production' },
    ],
  },
