      ...
      <section id="paketler" className="py-20 px-6">
        <div className="max-w-[1280px] mx-auto">
          ...
          <PackageCarousel
            packages={packages}
            showPrice
            ctaLabel={t.carousel.getStarted}
          />
      ...
      <footer className="bg-white/[0.03] border-t border-white/[0.05] py-8 px-6">
        <div className="max-w-[1280px] mx-auto flex flex-col sm:flex-row items-center justify-between gap-4">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/alhezarsLogo.png" alt="Alhezars" width={22} height={22} className="object-contain" />
          ...
          >
            <Globe className="w-3.5 h-3.5 opacity-50" /> {t.nav.webDesign}{' '}
          </Link>
        </div>
      </footer>
    </main>
