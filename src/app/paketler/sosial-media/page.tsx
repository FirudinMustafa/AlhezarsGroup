...
const MARQUEE_ITEMS = [
  'Instagram', 'TikTok', 'YouTube', 'Reels', 'Stories',
  'Shorts', 'Meta Ads', 'Targeting', 'Mobilograf', 'AI Video',
];
    ...
    <div className="overflow-hidden">
      ...
      >
        {doubled.map((item, i) => (
          ...
          >
            {item}
            <span className="w-1 h-1 rounded-full bg-fuchsia-600/35 flex-shrink-0" />
          </span>
        ))}
      </motion.div>
    </div>
        ...
        <div className="flex items-center justify-between h-16">
          ...
          <div className="hidden md:flex items-center gap-7">
            {[
              ...
              { label: 'Web Dizayn', href: '/paketler/web-dizayn' },
          ...
          <MagneticButton>
            ...
            >
              Əlaqə <ArrowRight className="w-3.5 h-3.5" />
            </motion.a>
          </MagneticButton>
...
function SocialHero() {
  ...
  return (
    ...
    >
      ...
      {/* Ambient orbs */}
      <div className="absolute top-[10%] left-[5%] w-[700px] h-[700px] bg-fuchsia-700/10 rounded-full blur-[160px] pointer-events-none" />
      <div className="absolute bottom-[5%] right-[0%] w-[500px] h-[500px] bg-purple-600/10 rounded-full blur-[140px] pointer-events-none" />

      {/* Mouse-tracking glow */}
      <motion.div
        className="absolute w-[480px] h-[480px] bg-fuchsia-600/8 rounded-full blur-[130px] pointer-events-none"
      ...
      <div className="relative max-w-6xl mx-auto px-5 sm:px-8 text-center">
        ...
        <motion.div
          ...
          className="inline-flex items-center gap-2 px-4 py-1.5 mb-10 text-xs font-bold text-fuchsia-300 bg-fuchsia-500/10 border border-fuchsia-500/20 rounded-full uppercase tracking-wider"
        >
          <motion.span
        ...
        <h1 className="text-[clamp(40px,7.5vw,84px)] font-black tracking-tight leading-[1.0] mb-3">
          <span className="block text-white">
            <WordReveal words={['Instagram,']} baseDelay={0.1} />
          </span>
          <span className="block bg-gradient-to-r from-fuchsia-300 via-purple-400 to-violet-400 bg-clip-text text-transparent">
            <WordReveal words={['TikTok', '&', 'daha', 'çox']} baseDelay={0.25} />
          </span>
          <span className="block text-white/80">
            <WordReveal words={['Biz', 'idarə', 'edirik']} baseDelay={0.55} />
          </span>
        </h1>
        ...
        >
          Mobiloqraf, videoqraf, motion dizayn, targeting —{' '}
          <span className="text-white/55">
            brendinizin sosial media hekayəsini biz yazırıq.
          </span>
        </motion.p>
        ...
        >
          {[
            { to: 5, suffix: '', label: 'Paket seçimi' },
            { to: 184, suffix: '', label: 'Max kontent/ay' },
            { to: 9, suffix: '+', label: 'Platform dəstəyi' },
    ...
    <section id="paketler" className="py-28 relative">
      ...
      <div className="max-w-7xl mx-auto px-5 sm:px-8">
        <FadeUp className="text-center mb-16">
          <p className="text-fuchsia-400 text-xs font-bold uppercase tracking-[0.25em] mb-4">
            Sosial Media
          </p>
        ...
        <div className="flex flex-wrap justify-center gap-5">
          {SOCIAL_PACKAGES.map((pkg, i) => (
            <FadeUp key={pkg.name} delay={i * 0.08} className="w-full sm:max-w-[272px]">
              <motion.div
              ...
              >
                ...
                <div className="p-5 flex-1">
                  ...
                  <p className="text-white/40 text-xs mb-0.5">{pkg.subtitle}</p>
                  <p className="text-white/20 text-xs mb-5">{pkg.contentCount} kontent/ay</p>
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      <motion.div
        ...
        className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[600px] bg-purple-700 rounded-full blur-[220px] pointer-events-none"
      />
      ...
      <div className="relative max-w-3xl mx-auto px-5 sm:px-8 text-center">
        <FadeUp>
          ...
          <p className="text-white/30 text-lg mb-10 max-w-md mx-auto leading-relaxed">
            Brendinizə uyğun paketi seçin, bizimlə əlaqə saxlayın.
          </p>
    ...
    <footer className="border-t border-white/[0.05] py-8">
      <div className="max-w-7xl mx-auto px-5 sm:px-8 flex flex-col sm:flex-row items-center justify-between gap-4">
        ...
        <Link
          ...
          className="flex items-center gap-1.5 text-sm text-white/30 hover:text-white transition-colors group"
        >
          <Globe className="w-3.5 h-3.5 text-blue-400/60 group-hover:text-blue-400 transition-colors" />
