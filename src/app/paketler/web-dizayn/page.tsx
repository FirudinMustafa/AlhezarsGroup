                ...
                <AnimatePresence>
                  {pkgOpen && (
                    <motion.div initial={{ opacity: 0, y: 6 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: 6 }} transition={{ duration: 0.15 }} className="absolute top-full left-1/2 -translate-x-1/2 mt-3 w-48 bg-white/90 backdrop-blur-2xl border border-black/[0.06] rounded-xl overflow-hidden p-1 shadow-lg shadow-black/[0.08]">
                      <Link href="/paketler/sosial-media" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg hover:bg-black/[0.04] text-[#6e6e73] hover:text-[#1d1d1f] text-[13px]">
                        <Instagram className="w-3.5 h-3.5 flex-shrink-0 opacity-40" /> Sosial Media
                      </Link>
                      <Link href="/paketler/web-dizayn" className="flex items-center gap-2.5 px-3 py-2.5 rounded-lg hover:bg-black/[0.04] text-[#1d1d1f] font-medium text-[13px]">
                  ...
                  <AnimatePresence>
                    {mobilePkgOpen && (
                      <motion.div initial={{ height: 0, opacity: 0 }} animate={{ height: 'auto', opacity: 1 }} exit={{ height: 0, opacity: 0 }} transition={{ duration: 0.15 }} className="overflow-hidden">
                        <Link href="/paketler/sosial-media" onClick={() => setOpen(false)} className="block py-2.5 pl-4 text-[15px] text-[#86868b]">Sosial Media</Link>
                        <Link href="/paketler/web-dizayn" onClick={() => setOpen(false)} className="block py-2.5 pl-4 text-[15px] text-[#1d1d1f] font-medium">Web Dizayn</Link>
                      </motion.div>
                    )}
                  </AnimatePresence>
                </div>
